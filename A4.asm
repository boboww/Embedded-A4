...
Start:    
    ...
    CLRF    PORTD	    ;clear port C
    CLRF    LATD	    ;clear latch C
    CLRF    TRISD	    ;set port C to output  
...
Main:   
    ...
    MOVLW   b'10000000'	    ;turn only 001 on
    MOVWF   PORTD
    CALL    Delay    
    ...
    CALL    Lookup	    ;call lookup table
    MOVWF   PORTB	    ;write pattern in w to LEDs.
    MOVLW   b'01000000'	    ;turn only 010 on
    MOVWF   PORTD
    CALL    Delay
    ...
    CALL    Lookup	    ;call lookup table   
    MOVWF   PORTB	    ;write pattern in w to LEDs. 
    MOVLW   b'00100000'	    ;turn only 100 on
    MOVWF   PORTD
    CALL    Delay
